...
export const AuthHeader: React.FC<AuthHeaderProps> = ({
  ...
  return (
    <div className="space-y-2 text-center md:text-left flex flex-col items-center md:items-start mb-6">
      ...
      <motion.p
        ...
        className="text-xs md:text-sm text-muted-foreground font-semibold leading-relaxed"
      >
        {subtitle}
      </motion.p>
    </div>
